...
- (DONE) update favicon. 
- (DONE) Figure out addresses - some aren't known and should I display P+R? different api... => https://gent.opendatasoft.com/explore/dataset/locaties-openbare-parkings-gent/table/ , end up not showing Park and Ride as they aren't real parkings (out of scope).
