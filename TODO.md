...
- Figure out addresses - some aren't known
- Find availability parking Kouter
- Display P+R? different api...
- Show live availability (different api's)
- add dutch to the app?
- If the user navigates to a certain parking space page and they have not filled in their profile information yet, they should instead be rerouted to the profile page. 
